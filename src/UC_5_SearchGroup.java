...
class UC_5_SearchGroup{

	@Test
	void TC_1001_SearchGroup() {
	...
	void  TC_1002_SearchGroup() {
		...
		driver = new ChromeDriver();
		 ...
		 driver.get("https://tzs-global.com/alumni-1/index.php/Welcome/");
		    ...
		    driver.findElement(By.linkText("ข้อมูลศิษย์เก่าทั้งหมด")).click();
		    driver.findElement(By.name("search")).click();
		    driver.findElement(By.name("search")).sendKeys("60/45");
		    driver.findElement(By.name("submit")).click();
		    String result = driver.findElement(By.id("name")).getText(); 
	...
	void TC_1003_SearchGroup() {
		...
		driver = new ChromeDriver();
		 ...
		 driver.get("https://tzs-global.com/alumni-1/index.php/Welcome/");
		    ...
		    driver.findElement(By.linkText("ข้อมูลศิษย์เก่าทั้งหมด")).click();
		    driver.findElement(By.name("search")).click();
		    driver.findElement(By.name("search")).sendKeys("63/45");
		    driver.findElement(By.name("submit")).click();
