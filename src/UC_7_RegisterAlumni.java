...
class UC_7_RegisterAlumni {
	...
	void TC_1001_Register() {
	    ...
	    driver.findElement(By.name("fname")).sendKeys("เมืองแมน สระทองจีน");
	    ...
	    driver.findElement(By.name("nation")).click();
	    driver.findElement(By.name("nation")).sendKeys("ไทย");
	    driver.findElement(By.name("nation2")).click();
	    driver.findElement(By.name("nation2")).sendKeys("ไทย");
	    driver.findElement(By.name("re")).click();
	    driver.findElement(By.name("re")).sendKeys("พุทธ");
	...
	void TC_1002_Register() {
	    ...
	    driver.findElement(By.linkText("ลงทะเบียน")).click();
	    driver.findElement(By.name("fname")).click();
	    driver.findElement(By.name("fname")).sendKeys("ใจดี สวยสวย");
	    driver.findElement(By.name("ename")).click();
	...
	void TC_1003_Register() {
        ...
        assertEquals("ระบบลงทะเบียนสมาคมศิษย์เก่า",result);
	    driver.close();
