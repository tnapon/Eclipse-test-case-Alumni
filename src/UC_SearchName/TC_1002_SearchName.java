	...
	void test() {
		...
		driver = new ChromeDriver();
		 ...
		 driver.get("https://tzs-global.com/alumni-1/index.php/Welcome/");
		    ...
		    driver.findElement(By.name("search")).sendKeys("∏πæ≈");
		    driver.findElement(By.name("submit")).click();
		    driver.findElement(By.name("search")).click();
		    driver.findElement(By.name("search")).sendKeys("∏πæ≈");
		    driver.findElement(By.name("submit")).click();
		   // assertThat(driver.findElement(By.cssSelector("tbody:nth-child(2) th:nth-child(2)")).getText(), is("∏πæ≈"));
		    String result = driver.findElement(By.id("name")).getText();
		     //driver.findElement(By.xpath("/html/body/div/div/div/div[2]/table/tbody/tr/th[2][text()=\"‡©≈‘¡√—∞ æ√¡ Õ“¥\"]"));
