...
class UC_3_SearchProvince{

	@Test
	void TC_1001_SearchProvince() {
	...
	void TC_1003_SearchProvince() {
		...
		driver = new ChromeDriver();
		 ...
		 driver.get("https://tzs-global.com/alumni-1/index.php/Welcome/");
		    ...
		    driver.findElement(By.linkText("ข้อมูลศิษย์เก่าทั้งหมด")).click();
		    driver.findElement(By.name("search")).click();
		    driver.findElement(By.name("search")).sendKeys("เพรชบุรี");
		    driver.findElement(By.name("submit")).click();
